  ...
  [2],
  {
          ...
          return "auto" === c
            ...
            ? c.map(function(t) {
                return (function t(e, n, i) {
                  ...
                  if (Array.isArray(e))
                    return Object.assign(p(n, e[0], i), { title: e[1] });
                  var a = e.children || [];
        ...
        return [
          ...
          function(t) {
            ...
            for (var h, f = [], p = 0; null !== (h = u(s, l)); ) {
              var d = String(h[0]);
              (f[p] = d),
                "" === d && (s.lastIndex = o(l, a(s.lastIndex), c)),
                p++;
            }
            return 0 === p ? null : f;
          }
              ...
              function(t, r) {
                ...
                var h = a(t),
                  ...
                  m =
                    ...
                    (h.unicode ? "u" : "") +
                    (g ? "y" : "g"),
                  b = new p(g ? h : "^(?:" + h.source + ")", m),
                  k = void 0 === r ? 4294967295 : r >>> 0;
                if (0 === k) return [];
                if (0 === f.length) return null === c(b, f) ? [f] : [];
                for (var _ = 0, x = 0, C = []; x < f.length; ) {
                  b.lastIndex = g ? x : 0;
                  var $,
                    y = c(b, g ? f : f.slice(x));
                  if (
                    null === y ||
                    ($ = d(l(b.lastIndex + (g ? 0 : x)), f.length)) === _
                  )
                    x = u(f, x, v);
                  else {
                    if ((C.push(f.slice(_, x)), C.length === k)) return C;
                    for (var L = 1; L <= y.length - 1; L++)
                      if ((C.push(y[L]), C.length === k)) return C;
                    x = _ = $;
                  }
                }
    ...
    523: function(t, e, n) {
      ...
      var i = n(1),
        r = n(522).trim;
      i(
        { target: "String", proto: !0, forced: n(535)("trim") },
        {
          trim: function() {
            return r(this);
          }
        ...
        for (
          var $ = function(t, e) {
              var n,
                ...
                r = l(t),
                a = void 0 === e;
              if (!i && r && t.constructor === $ && a) return t;
              x
                ? r && !a && (t = t.source)
                : t instanceof $ && (a && (e = c.call(t)), (t = t.source)),
                C &&
                  (n = !!e && e.indexOf("y") > -1) &&
                  (e = e.replace(/y/g, ""));
          ...
          y(L[w++]);
        (b.constructor = $), ($.prototype = b), f(r, "RegExp", $);
      }
      g("RegExp");
    },
    525: function(t, e) {
    ...
    526: function(t, e, n) {
      ...
      var i = n(503),
        r = {
          name: "SidebarGroup",
          components: { DropdownTransition: n(527).a },
          props: ["item", "open", "collapsable", "depth"],
          beforeCreate: function() {
            this.$options.components.SidebarLinks = n(526).default;
          },
    ...
    528: function(t, e, n) {
      ...
      var i = n(1),
        r = n(529);
      i(
        { target: "String", proto: !0, forced: n(530)("link") },
        {
          link: function(t) {
    ...
    555: function(t, e, n) {
      ...
      var i = n(503),
        ...
        h = function(t, e) {
          var n =
            ...
            i = c()(e, "title", "");
          return (
            c()(e, "frontmatter.tags") &&
              (i += " ".concat(e.frontmatter.tags.join(" "))),
            n && (i += " ".concat(n)),
            f(t, i)
          );
        },
            ...
            suggestions: function() {
              ...
              if (t) {
                for (
                  ...
                  var s = e[a];
                  if (this.getPageLocalePath(s) === i && this.isSearchable(s))
                    if (h(t, s)) r.push(s);
                    else if (s.headers)
                      for (
                        var o = 0;
                        o < s.headers.length && !(r.length >= n);
                        o++
                      ) {
                        var u = s.headers[o];
                        u.title &&
      ...
      var A = N,
        ...
        H = {
          name: "Sidebar",
          components: { SidebarLinks: n(526).default, NavLinks: C },
          props: ["items"]
        },
        W =
          (n(552),
